...
class Puzzle : BasePuzzle() {
    ...
    fun runPart1() {
        assertRun(5, true)
        assertRun(187, isExample = false, toConsole = true)
    }

    @Test
    fun runPart2() {
        assertRun(11, true)
        assertRun(3490, isExample = false, toConsole = true)
    }

    @Test
    fun runPart3() {
        assertRun(3442321, true)
        assertRun(1667582509, isExample = false, toConsole = true)
    }

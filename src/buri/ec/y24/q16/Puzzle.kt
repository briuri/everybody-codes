...
class Puzzle : BasePuzzle() {
    ...
    fun runPart1() {
        assertRun(">.- -.- ^,-", true)
        assertRun("<:- ^_^ <:< <.>", false, true)
    }

    @Test
    fun runPart2() {
        assertRun("280014668134", true)
        assertRun("129567491554", false, true)
    }

    @Test
    fun runPart3() {
        assertRun("627 128", true)
        assertRun("572 64", false, true)
    }
